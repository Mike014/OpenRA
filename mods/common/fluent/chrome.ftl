...
tiling-path-segment-beach = Beach
tiling-path-segment-clear = Clear
tiling-path-segment-cliff = Cliff
tiling-path-segment-cliff-maybecorner = Cliff Corner
tiling-path-segment-dune = Dune
tiling-path-segment-iceshore = Ice Shore
tiling-path-segment-river = River
tiling-path-segment-road = Road
tiling-path-segment-road-in = Road (Inbound)
tiling-path-segment-road-main = Road (Main)
tiling-path-segment-road-out = Road (Outbound)
tiling-path-segment-rock = Rock
tiling-path-segment-rockrockcliff = Rock-Rock Cliff
tiling-path-segment-rocksandcliff = Rock-Sand Cliff
tiling-path-segment-rocksmooth = Smooth Rock
tiling-path-segment-sand = Sand
tiling-path-segment-sandplatform = Sand Platform
tiling-path-segment-sandrockcliff = Sand-Rock Cliff
tiling-path-segment-sandsandcliff = Sand-Sand Cliff
tiling-path-segment-shore = Shore
tiling-path-segment-watercliff = Water Cliff
tiling-path-segment-watercliff-maybecorner = Water Cliff Corner
